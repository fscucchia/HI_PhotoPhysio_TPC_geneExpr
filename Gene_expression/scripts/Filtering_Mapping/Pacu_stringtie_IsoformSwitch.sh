#!/bin/bash
#SBATCH --job-name=Pacu-stringtie_IsoformSwitch
#SBATCH --nodes=1 --cpus-per-task=15
#SBATCH --mem=200G  # Requested Memory
#SBATCH -t 24:00:00
#SBATCH -o slurm-Pacu-stringtie_IsoformSwitch.out  # %j = job ID
#SBATCH -e slurm-Pacu-stringtie_IsoformSwitch.err  # %j = job ID
...
# W="/scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Mapping_Hisat_Pacu"
# mkdir -p gene_abundance
# mkdir -p Stringtie
...
#   for i in ${array1[@]}; do
#         stringtie -p 8 --rf -G /work/pi_hputnam_uri_edu/HI_Genomes/PacutaV2/Pocillopora_acuta_HIv2.genes.gff3 -A ${i}.gene_abund.tab -o ${i}.gtf ${i}
#         mv ${i}.gtf /scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Mapping_Hisat_Pacu/Stringtie
...
#   for i in ${array1[@]}; do
#         stringtie -p 8 --rf -G /work/pi_hputnam_uri_edu/snRNA_analysis/references/Pocillopora_acuta_HIv2_modified.gtf -B -A ${i}.IsoformSwitch_gene_abund.tab -o ${i}_IsoformSwitch.gtf ${i}
#         mv ${i}_IsoformSwitch.gtf /scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Mapping_twopassMode_Pacu/Stringtie_IsoformSwitch
...
W="/scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Mapping_twopassMode_Pacu"
  ...
  for i in ${array1[@]}; do
        ...
        mv ${i}_IsoformSwitch_final.gtf /scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Mapping_twopassMode_Pacu/Stringtie_IsoformSwitch_final
