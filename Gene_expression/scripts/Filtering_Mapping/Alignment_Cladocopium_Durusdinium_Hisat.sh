...
#SBATCH -D /scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Mapping_Cladoc_Durusd_Hisat_Mcap
...
# hisat2-build -f /scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Symbiont_Genomes_concat/Cladocopium_Durusdinium/Cladocopium_Durusdinium_concat.fasta ./CladoDurusHisat_ref # called the reference genome (scaffolds)
...
# array1=($(ls $F/trim.Mcap*_R1_001.fastq.gz)) # Aligning paired end reads
...
#     sam_output="/scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Mapping_Cladoc_Durusd_Hisat_Mcap/${base_name}.sam"
#     bam_output="/scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Mapping_Cladoc_Durusd_Hisat_Mcap/${base_name}.bam"
#     summary_output="/scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Mapping_Cladoc_Durusd_Hisat_Mcap/${base_name}.txt"

#     # Run HISAT2
#     hisat2 -p 8 --new-summary --rf --dta -q -x CladoDurusHisat_ref \
...
H="/scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Mapping_Cladoc_Durusd_Hisat_Mcap"
