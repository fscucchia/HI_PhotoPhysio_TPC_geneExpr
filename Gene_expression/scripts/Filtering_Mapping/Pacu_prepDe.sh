#!/bin/bash
#SBATCH --job-name=Pacu-prepDe
#SBATCH --nodes=1 --cpus-per-task=15
#SBATCH --mem=200G  # Requested Memory
#SBATCH -t 24:00:00
#SBATCH -o slurm-Pacu-prepDe_IsoformSwitch.out  # %j = job ID
#SBATCH -e slurm-Pacu-prepDe_IsoformSwitch.err  # %j = job ID
...
# # run prepDe script
# python /work/pi_hputnam_uri_edu/fscucchia/20250424_ENCORE_HawaiiTPC_Federica/scripts/prepDE.py3 -g ./gene_count_matrix_noIso_Pacu.csv -i ./sample_list.txt
# #IsoformSwitch
python /work/pi_hputnam_uri_edu/fscucchia/20250424_ENCORE_HawaiiTPC_Federica/scripts/prepDE.py3 -g ./gene_count_matrix_IsoformSwitch_Pacu.csv -i ./sample_list_IsoformSwitch.txt
