...
#SBATCH -t 24:00:00
#SBATCH -o slurm-stringite-Pacu_IsoformSwitch.out  # %j = job ID
#SBATCH -e slurm-stringtie-Pacu_IsoformSwitch.err  # %j = job ID
...
#stringtie --merge -p 8 -G /work/pi_hputnam_uri_edu/snRNA_analysis/references/Pocillopora_acuta_HIv2_modified.gtf list_to_merge_IsoformSwitch.txt -o ./stringtie_merged_IsoformSwitch.gtf 

# #Use the program gffcompare to compare the merged GTF files to the reference genome
gffcompare -r /work/pi_hputnam_uri_edu/snRNA_analysis/references/Pocillopora_acuta_HIv2_modified.gtf stringtie_merged_IsoformSwitch.gtf -o ./compared_IsoformSwitch 
