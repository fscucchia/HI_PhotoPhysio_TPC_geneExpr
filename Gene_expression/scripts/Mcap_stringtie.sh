...
#SBATCH -t 24:00:00
#SBATCH -o slurm-Mcap-stringite.out  # %j = job ID
#SBATCH -e slurm-Mcap-stringtie.err  # %j = job ID
...
#   for i in ${array1[@]}; do
#         stringtie -p 8 --rf -G /work/pi_hputnam_uri_edu/snRNA_analysis/references/Montipora_capitata_HIv3.gtf -A ${i}.gene_abund.tab -o ${i}.gtf ${i}
#         mv ${i}.gtf /scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Mapping_twopassMode_Mcap/Stringtie
#         echo "StringTie-assembly-to-ref ${i}" $(date)
#   done
...
W="/scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Mapping_twopassMode_Mcap"
  ...
  for i in ${array1[@]}; do
        ...
        mv ${i}.final_gtf /scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Mapping_twopassMode_Mcap/Stringtie
        echo "StringTie-assembly-to-ref ${i}" $(date)
  done