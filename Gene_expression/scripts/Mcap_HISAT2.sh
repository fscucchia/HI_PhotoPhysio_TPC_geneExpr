...
#SBATCH -t 24:00:00
#SBATCH -o slurm-Mcap-Hisat-align.out  # %j = job ID
#SBATCH -e slurm-Mcap-Hisat-align.err  # %j = job ID
...
#SBATCH -D /scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Mapping_Hisat_Mcap
...
# hisat2-build -f /work/pi_hputnam_uri_edu/HI_Genomes/MCapV3/Montipora_capitata_HIv3.assembly.fasta ./McapHisat_ref # called the reference genome (scaffolds)
...
#     sam_output="/scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Mapping_Hisat_Mcap/${base_name}.sam"
#     bam_output="/scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Mapping_Hisat_Mcap/${base_name}.bam"
#     summary_output="/scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Mapping_Hisat_Mcap/${base_name}.txt"

#     # Run HISAT2
#     hisat2 -p 8 --new-summary --rf --dta -q -x McapHisat_ref \
...
H="/scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Mapping_Hisat_Mcap"
