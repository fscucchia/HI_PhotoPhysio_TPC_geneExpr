#!/bin/bash
#SBATCH --job-name=Pcom-Hisat
#SBATCH --nodes=1 --cpus-per-task=15
#SBATCH --mem=200G  # Requested Memory
#SBATCH -t 24:00:00
#SBATCH -o slurm-Pcom-Hisat-align.out  # %j = job ID
#SBATCH -e slurm-Pcom-Hisat-align.err  # %j = job ID
...
#SBATCH -D /scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Mapping_Hisat_Pcom
...
# hisat2-build -f /work/pi_hputnam_uri_edu/HI_Genomes/Pcompressa/Porites_compressa_HIv1.assembly.fasta ./PcomHisat_ref # called the reference genome (scaffolds)
...
#     sam_output="/scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Mapping_Hisat_Pcom/${base_name}.sam"
#     bam_output="/scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Mapping_Hisat_Pcom/${base_name}.bam"
#     summary_output="/scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Mapping_Hisat_Pcom/${base_name}.txt"

#     # Run HISAT2
#     hisat2 -p 8 --new-summary --rf --dta -q -x PcomHisat_ref \
...
H="/scratch/workspace/federica_scucchia_uri_edu-hawaii/20250424_ENCORE_HawaiiTPC_Federica/output/Mapping_Hisat_Pcom"
